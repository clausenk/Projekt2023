...
scatter_plot2 = alt.Chart(df).mark_circle(size=60).encode(
    x=alt.X('Impact', scale=alt.Scale(zero=False), axis=x_axis),
    y=alt.Y('Certainty', scale=alt.Scale(zero=False), axis=y_axis),
    tooltip=['Indikator']
).properties(
...
scatter_plot3 = alt.Chart(df).mark_circle(size=60).encode(
    x=alt.X('Impact', scale=alt.Scale(zero=False), axis=x_axis),
    y=alt.Y('Certainty', scale=alt.Scale(zero=False), axis=y_axis),
    tooltip=['Indikator']
).properties(
...
scatter_plots = (scatter_plot1 + point | scatter_plot2 | scatter_plot3).resolve_scale(
    x='shared',
    y='shared'
)
