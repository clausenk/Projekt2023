...
point_groupOne_megatrends = alt.Chart(subset_df.loc[(subset_df['Prognose Group'] == 'Group 2') & (subset_df['Kategorie'] == 'Megatrend')]).mark_point(size=symbol_size).encode(
...
point_groupOne_trends = alt.Chart(subset_df.loc[(subset_df['Prognose Group'] == 'Group 2') & (subset_df['Kategorie'] == 'Trend')]).mark_point(size=symbol_size).encode(
...
point_groupOne_signal = alt.Chart(subset_df.loc[(subset_df['Prognose Group'] == 'Group 2') & (subset_df['Kategorie'] == 'Signal')]).mark_point(size=symbol_size).encode(
    x=alt.X('Impact', scale=alt.Scale(domain=(0, 5)), axis=x_axis),
    y=alt.Y('Certainty', scale=alt.Scale(zero=False), axis=y_axis_with_labels),
    tooltip=['Indikator', 'Kategorie', 'STEEP-Kategorie', 'Certainty', 'Impact', 'Prognose Group'],
...
point_groupOne_schwachessignal = alt.Chart(subset_df.loc[(subset_df['Prognose Group'] == 'Group 2') & (subset_df['Kategorie'] == 'Schwaches Signal')]).mark_point(size=symbol_size).encode(
    x=alt.X('Impact', scale=alt.Scale(domain=(0, 5)), axis=x_axis),
    y=alt.Y('Certainty', scale=alt.Scale(zero=False), axis=y_axis_with_labels),
    tooltip=['Indikator', 'Kategorie', 'STEEP-Kategorie', 'Certainty', 'Impact', 'Prognose Group'],
...
point_groupOne_treiber = alt.Chart(subset_df.loc[(subset_df['Prognose Group'] == 'Group 2') & (subset_df['Kategorie'] == 'Treiber')]).mark_point(size=symbol_size).encode(
    x=alt.X('Impact', scale=alt.Scale(domain=(0, 5)), axis=x_axis),
    y=alt.Y('Certainty', scale=alt.Scale(zero=False), axis=y_axis_with_labels),
    tooltip=['Indikator', 'Kategorie', 'STEEP-Kategorie', 'Certainty', 'Impact', 'Prognose Group'],
...
scatter_plot1_text_signal = alt.Chart(subset_df.loc[(subset_df['Prognose Group'] == 'Group 2') & (subset_df['Kategorie'] == 'Signal') ]).mark_text(size=15, opacity=1.0, color=signal_color, dy=-15).encode(
...
scatter_plot1_text_trend = alt.Chart(subset_df.loc[(subset_df['Prognose Group'] == 'Group 2') & (subset_df['Kategorie'] == 'Trend') ]).mark_text(size=15, opacity=1.0, color=trend_color, dy=-15).encode(
    x=alt.X('Impact', title='Impact', scale=alt.Scale(domain=(0, 5)), axis=alt.Axis(format='~')),
    y=alt.Y('Certainty', title='Certainty', scale=alt.Scale(zero=False), axis=alt.Axis(format='~')),
    text='Indikator:N'
).properties(
...
scatter_plot1_text_treiber = alt.Chart(subset_df.loc[(subset_df['Prognose Group'] == 'Group 2') & (subset_df['Kategorie'] == 'Treiber') ]).mark_text(size=15, opacity=1.0, color=treiber_color, dy=-15).encode(
    x=alt.X('Impact', title='Impact', scale=alt.Scale(domain=(0, 5)), axis=alt.Axis(format='~')),
    y=alt.Y('Certainty', title='Certainty', scale=alt.Scale(zero=False), axis=alt.Axis(format='~')),
    text='Indikator:N'
).properties(
...
scatter_plot1_text_schwachessignal = alt.Chart(subset_df.loc[(subset_df['Prognose Group'] == 'Group 2') & (subset_df['Kategorie'] == 'Schwaches Signal') ]).mark_text(size=15, opacity=1.0, color=schwachessignal_color, dy=-15).encode(
    x=alt.X('Impact', title='Impact', scale=alt.Scale(domain=(0, 5)), axis=alt.Axis(format='~')),
    y=alt.Y('Certainty', title='Certainty', scale=alt.Scale(zero=False), axis=alt.Axis(format='~')),
    text='Indikator:N'
).properties(
